...
import { LoaderCircle, CircleCheckBig, CircleX, Clock, RefreshCw, FileText } from 'lucide-react';
                ...
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    {(job.status === 'processing' || job.status === 'pending') && (
                      <ProgressBar
                        className="mt-3"
                        value={job.status === 'pending' ? 8 : null}
                        label={job.status === 'pending' ? 'Queued' : 'Generating'}
                      />
                    )}
                    {job.status === 'completed' && (
                      <ProgressBar className="mt-3" value={100} label="Complete" />
                    )}
