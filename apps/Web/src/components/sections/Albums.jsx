...
export const Albums = () => {
  ...
  const [_selectedPhoto, setSelectedPhoto] = useState(null);
      ...
      {isUploading && uploadProgress.total > 0 && (
        <div className="fixed top-20 right-4 bg-white rounded-xl shadow-xl p-4 z-50 min-w-[300px] border border-slate-200">
          ...
          <ProgressBar
            ...
            label={`${uploadProgress.current} of ${uploadProgress.total} photos`}
          />
        </div>
      )}
            ...
            <div className="flex items-center justify-between p-4 sm:p-6 border-b border-slate-200">
              ...
              <div className="flex items-center gap-2">
                {canUploadPhotos && (
                  ...
                  >
                    {isUploading && uploadingEventId === selectedEvent.id ? (
                      <SmartSpinner active variant="inline" light label="Uploading" messages={['Still uploading', 'Almost there']}>
                        <>
                          <Upload className="w-4 h-4" />
                          <span>Upload</span>
                        </>
                ...
                {selectedEvent.photos && selectedEvent.photos.length > 0 && (
                  ...
                  >
                    {isDownloadingAll ? (
                      <SmartSpinner active variant="inline" light label="Downloading" messages={['Still downloading', 'Almost there']}>
                        <>
