...
import { MessageSquare, Plus, Send, Clock, CircleAlert, CircleCheck, CircleX, Filter } from 'lucide-react';
    ...
    try {
      ...
      if (result.error) {
        ...
        statusDialog({
          ...
          message: 'We’ll follow up in this thread. You can keep chatting from Support.',
        });
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewTicketSubject(e.target.value.slice(0, FIELD_LIMITS.ticketSubject))}
                    maxLength={FIELD_LIMITS.ticketSubject}
                    placeholder="Brief description of your issue..."
                    className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                  <CharCount value={newTicketSubject} max={FIELD_LIMITS.ticketSubject} />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setNewTicketMessage(e.target.value.slice(0, FIELD_LIMITS.ticketMessage))}
                    maxLength={FIELD_LIMITS.ticketMessage}
                    placeholder="Describe your issue in detail..."
                    rows={6}
                    className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                  />
                  <CharCount value={newTicketMessage} max={FIELD_LIMITS.ticketMessage} />
                </div>
              </div>
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-blue-900 text-white rounded-lg hover:bg-blue-800 transition-colors font-medium disabled:cursor-not-allowed disabled:bg-slate-200 disabled:text-slate-500"
                >
