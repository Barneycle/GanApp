...
export const EventMessages = () => {
  ...
  const handleDeleteMarkedConversations = async () => {
    ...
    const confirmed = await confirmDialog({
      ...
      message: `This will delete all messages in ${markedConversations.size} marked thread${markedConversations.size === 1 ? '' : 's'}. This cannot be undone.`,
      confirmText: `Delete ${markedConversations.size} thread${markedConversations.size === 1 ? '' : 's'}`,
      cancelText: 'Cancel',
      type: 'danger',
    });
    ...
    try {
      ...
      if (errorCount > 0) {
        ...
        toast.success(`${successCount} conversation${successCount === 1 ? '' : 's'} deleted`);
      }
              ...
              <>
                ...
                <div className="p-6 border-t border-slate-200">
                  <div className="flex gap-2">
                    ...
                    >
                      <SmartSpinner active={sending} variant="inline" light>
                        <Send size={20} />
                      </SmartSpinner>
                      Send
                    </button>
