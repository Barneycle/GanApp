...
import { notify, useToast, statusError } from '../Toast';
      ...
      try {
        ...
        for (const file of fileArray) {
          ...
          if (file.size > maxSizeMB * 1024 * 1024) {
            ...
            notify('error', `File ${file.name} is too large. Max size: ${maxSizeMB}MB`);
          ...
          >
            ...
            {uploading ? (
              ...
              <div className="w-full max-w-sm mx-auto text-center">
                ...
                <ProgressBar value={uploadProgress} label="Uploading photos" />
...
export const EditEvent = () => {
  ...
  const _pageSubtitle = isEditMode
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 sm:space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="mt-6 h-[calc(100dvh-3.5rem)] min-h-0 overflow-hidden">
                <CertificateDesigner
                  eventId={eventId}
                  draftMode={false}
                  onSave={(_config) => {
          ...
          <div className="flex justify-center pt-8">
            ...
            <button
              ...
              className="w-full px-6 py-3 rounded-xl text-lg font-semibold shadow-md transition-all duration-200 flex items-center justify-center space-x-2 bg-blue-900 text-white hover:bg-blue-800"
