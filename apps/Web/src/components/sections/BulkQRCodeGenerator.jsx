...
import { X, Download, CircleCheck, CircleAlert, Calendar, MapPin, Clock } from 'lucide-react';
...
export const BulkQRCodeGenerator = ({ isOpen, onClose, event }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} panelClassName="flex max-h-[90vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 flex items-start">
              <CircleAlert className="w-5 h-5 text-red-600 mr-3 mt-0.5" />
            ...
            <div className="mb-6">
              {generating && progress.total > 0 && (
                <ProgressBar
                  ...
                  max={progress.total}
                  label={`Generating QR codes (${progress.current}/${progress.total})`}
                />
              )}
              <div>
                <button
                ...
                >
                  {generating ? (
                    <SmartSpinner
                      ...
                      light
                      label="Generating"
                      messages={['Still generating', 'This is taking a bit longer', 'Almost there']}
                    >
